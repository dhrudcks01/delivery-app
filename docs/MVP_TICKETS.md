...
### [ ] T-0111 로그인 식별자 검증 완화(email 전용 -> string)
**Goal**
...
### [ ] T-0516 모바일 역할 기반 화면 진입 구조 개편(하단 탭 최소화)
**Goal**
...
### [ ] T-0518 USER 신청 화면 도로명 주소 검색 연동
**Goal**
