...
public class PaymentMethodRegistrationService {
    ...
    @Transactional
    public PaymentMethodRegistrationStartResponse startRegistration(String email) {
        ...
        String registrationUrl = UriComponentsBuilder
                ...
                .queryParam("successUrl", paymentRegistrationProperties.getSuccessUrl())
                .queryParam("failUrl", paymentRegistrationProperties.getFailUrl())
                .build(true)
                .toUriString();
        return new PaymentMethodRegistrationStartResponse(customerKey, registrationUrl);
    }
    ...
    public PaymentMethodRegistrationFailResponse registerFail(String code, String message) {
        ...
        String safeMessage = (message == null || message.isBlank()) ? "카드 등록에 실패했습니다." : message;
    ...
    private void validateCustomerKeyOwnership(String customerKey, Long authenticatedUserId) {
        ...
        if (!customerKeyUserId.equals(authenticatedUserId)) {
            throw new InvalidPaymentMethodRegistrationException("customerKey와 사용자 정보가 일치하지 않습니다.");
        }
    }
}
