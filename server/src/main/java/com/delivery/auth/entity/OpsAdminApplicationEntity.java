...
@Entity
@Table(name = "ops_admin_applications")
public class OpsAdminApplicationEntity {
    ...
    protected OpsAdminApplicationEntity() {
    }

    public OpsAdminApplicationEntity(UserEntity user, String status, String reason) {
        this.user = user;
        this.status = status;
        this.reason = reason;
    }
